...
def seed_comments():
    all_comments = [
        ...
        {'user_id': 2, 'post_id': 19, 'content': 'I want to compete.'},
        {'user_id': 7, 'post_id': 19, 'content': 'I love jiujitsu.'},
        {'user_id': 6, 'post_id': 19, 'content': 'So sore after my first class.'},
        {'user_id': 3, 'post_id': 20, 'content': 'Ground karate!!'},
        {'user_id': 5, 'post_id': 20, 'content': 'I wanna roll!!!'},
        {'user_id': 2, 'post_id': 20, 'content': 'BJJ is such a difficult sport...'},
        {'user_id': 1, 'post_id': 21, 'content': 'Roll til the wheels fall off'},
        {'user_id': 2, 'post_id': 21, 'content': 'I would rather wear out than rust out.'},
        {'user_id': 3, 'post_id': 21, 'content': 'Pajama ninjas!'},
        {'user_id': 4, 'post_id': 22, 'content': 'I love LA nights'},
        {'user_id': 7, 'post_id': 22, 'content': 'Great photo!'},
        {'user_id': 3, 'post_id': 22, 'content': 'Slick'},
        {'user_id': 8, 'post_id': 23, 'content': 'Great shot.'},
        {'user_id': 2, 'post_id': 23, 'content': 'Woah, surreal...'},
        {'user_id': 5, 'post_id': 23, 'content': 'Is that Mumbai?'},
        {'user_id': 3, 'post_id': 24, 'content': 'Tokyo has the largest population in the world.'},
        {'user_id': 2, 'post_id': 24, 'content': 'Nice aerial.'},
